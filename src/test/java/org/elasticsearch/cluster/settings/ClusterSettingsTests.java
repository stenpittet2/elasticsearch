...
public class ClusterSettingsTests extends ElasticsearchIntegrationTest {
    ...
    public void clusterNonExistingSettingsUpdate() {
        ...
        try {
            ...
            assertThat(errorMessage, containsString("Failed update transient setting"));
            assertThat(errorMessage, containsString(key1));
            assertThat(errorMessage, containsString(String.valueOf(value1)));
            assertThat(errorMessage, containsString("not dynamically updateable"));
        }
    }
